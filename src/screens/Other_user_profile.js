        ...
        return (
            <View style={{ flex: 1, }}>
                <ScrollView>
                    ...
                    <View style={{ height: 350, borderWidth: 0.5, borderColor: '#9e9e9e' }}>
                        <ImageBackground style={{ width: "100%", height: "100%", }} source={require('../Images/kk2.jpeg')} >
                            <View style={{ height: '100%', width: '100%' }}>
                                <ImageBackground style={{ width: "100%", height: "100%", opacity: 0.8, }} source={require('../Images/backprofile.png')} >
                                    ...
                                    <View style={{ height: 100, width: '100%', flexDirection: 'row' }}>
                                        <View style={{ width: '100%', justifyContent: 'center', alignItems: 'center' }}>
                                            <TouchableOpacity onPress={() => { this.toggleModal(true) }}>
                                                <Image style={{ width: 70, height: 70, top: 30, borderRadius: 70 / 2 }} source={require('../Images/kk2.jpeg')} />
                                            </TouchableOpacity>
                                    ...
                                    <View style={{ alignItems: 'center', top: 10, height: 30, }}>
                                        <Image style={{ width: 15, height: 15, resizeMode: 'contain' }} source={require('../Images/heart.png')} />
                                    </View>
                                    <View style={{ alignItems: 'center', top: 10, height: 30, }}>
                                    ...
                                    <View style={{ height: 30, flexDirection: 'row', width: '100%', top: 10, justifyContent: 'space-evenly', alignItems: 'center' }}>
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: 110, }}>
                                            <View>
                                                <TouchableOpacity onPress={() => { this.props.navigation.navigate('Followesr_list') }}>
                                                    <Text style={{ color: "#fff" }}>2 Following</Text>
                                                </TouchableOpacity>
                                            </View>
                                        ...
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: 110, }}>
                                            <View>
                                                <TouchableOpacity onPress={() => { this.props.navigation.navigate('Followesr_list') }}>
                                                    <Text style={{ color: "#fff" }}>1 Followers</Text>
                                                </TouchableOpacity>
                                        ...
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', }}>
                                            <View>
                                                <Text style={{ color: "#fff" }}>0 Feels</Text>
                                            </View>
                                        </View>
                                    </View>
                                    {/* Gender Area  */}
                                    ...
                                    <View style={{ flexDirection: 'row', justifyContent: 'space-evenly', padding: 10, top: 20 }}>
                                        <TouchableOpacity style={{ padding: 10, borderWidth: 1, borderColor: '#9e9e9e', alignItems: 'center', borderRadius: 15, }}>
                                            <Text style={{ color: '#fff' }}>Message</Text>
                                        </TouchableOpacity>
                                        <TouchableOpacity style={{ paddingLeft:15, paddingRight:15,justifyContent:'center', borderWidth: 1, borderColor: '#9e9e9e', alignItems: 'center', borderRadius: 15, }}>
                ...
                <Modal animationType={"slide"} transparent={false}
                    ...
                    <View style={{ width: '100%', height: '100%', backgroundColor: '#000' }} >
                        ...
                        <View style={{ height: '90%', width: '100%', }}>
                            <Image style={{ width: '100%', height: '100%', resizeMode: 'contain' }} source={require('../Images/kk2.jpeg')}>
